...
bool urlDomainPathTest();
bool urlDomainPathLowerUpperCaseTest();
...
int main()
{
    ...
    if(urlDomainPathTest())
        std::cout << "urlDomainPathTest \tOK" << std::endl;
    else
        std::cout << "urlDomainPathTest \tFAILED" << std::endl;

    if(urlDomainPathLowerUpperCaseTest())
        std::cout << "urlDomainPathLowerUpperCaseTest \tOK" << std::endl;
    else
        std::cout << "urlDomainPathLowerUpperCaseTest \tFAILED" << std::endl;
...
bool urlDomainPathTest()
{
    URL url(L"http://stackoverflow.com/questions/313970/how-to-convert-stdstring-to-lower-case");
    if(url.scheme() != L"http")
        return false;
    ...
    if(url.host() != L"stackoverflow.com")
        return false;

    if(url.port() != 0)
        return false;

    if(url.path() != L"/questions/313970/how-to-convert-stdstring-to-lower-case")
        return false;
